...
cat(paste("The difference (magnitude) is",interpret_phi(phi_coefficient)," as the (effect size) - Phi Coefficient is:",phi_coefficient,"and the bayes factor indicate there is a",interpret_bf(5.18),"alternative hypothesis"))
```
...
cat(paste("The difference (magnitude) is",interpret_cramers_v(assocstats(table)$cramer)," as the (effect size) - Cramér's V is:",assocstats(table)$cramer,"and the bayes factor indicate there is a",interpret_bf(8.35),"alternative hypothesis"))
```
...
cat(paste("The difference (magnitude) is",interpret_cramers_v(assocstats(table)$cramer)," as the (effect size) - Cramér's V is:",assocstats(table)$cramer,"and the bayes factor indicate there is a",interpret_bf(18.4),"alternative hypothesis"))
```
...
cat(paste("The difference (magnitude) is",interpret_cramers_v(assocstats(table)$cramer)," as the (effect size) - Cramér's V is:",assocstats(table)$cramer,"and the bayes factor indicate there is a",interpret_bf(26.57),"alternative hypothesis"))
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
wilcox_effsize(formula =claimcst0~gender,data = df,paried=FALSE)
```

*The median claims in female group was 743.42, whereas the median in male group was 800.31. The wilcox_effsize test showed that the magnitude was small and the effect size= .0315* 
...
*The kruskal_effsize test showed that the magnitude was small and the effect size= 0.00468* 
...
*The kruskal_effsize test showed that the magnitude was small and the effect size= 0.00132* 
...
*The kruskal_effsize test showed that the magnitude was small and the effect size= 0.0338* 
...
*The kruskal_effsize test showed that the differences was small and the effect size= 0.00339* 
